...
/*   Updated: 2018/10/31 14:27:51 by ghtouman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		modif_l(void *element, pf_flags flags)
{
	if ( flags.index_s == 3)
	{
		ft_write_p_u((unsigned long int)element, flags, 8);
		ft_putnbr_base((unsigned long int)element, 8, 0);
	}
	else if (flags.index_s == 5)
	{
		ft_write_p_u((unsigned long int)element, flags, 10);
		ft_putnbr_base((unsigned long int)element, 10, 0);
	}
	else if (flags.index_s == 7)
	{
		ft_write_p_u((unsigned long int)element, flags, 16);
...
void		modif_ll(void *element, pf_flags flags)
{
	if ( flags.index_s == 3)
	{
		ft_write_p_u((unsigned long long int)element, flags, 8);
		ft_putnbr_base((unsigned long long int)element, 8, 0);
	}
	else if (flags.index_s == 5)
	{
		ft_write_p_u((unsigned long long int)element, flags, 10);
		ft_putnbr_base((unsigned long long int)element, 10, 0);
	}
	else if (flags.index_s == 7)
	{
		ft_write_p_u((unsigned long long int)element, flags, 16);
	...
	{
		ft_write_p((long long int)element, flags, 10);
